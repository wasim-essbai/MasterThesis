...
\usepackage[hidelinks, bookmarksopen=true, breaklinks = true]{hyperref}
...
\begin{document}
	...
	\begin{frontespizio}
		...
		\Corso[Laurea Magistrale]{Ingegneria Informatica\\Classe N. LM-32 – Classe delle lauree magistrali in Ingegneria Informatica}
